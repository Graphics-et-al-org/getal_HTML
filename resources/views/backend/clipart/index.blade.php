...
@section('content')
    ...
    <div class="flex rounded-md shadow-sm w-100">
        ...
        <button type="button" onclick="window.confirmRefreshMetadata()"
            class="px-4 py-2 m-4 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
            Refresh all AI metadata
        </button>
        <button type="button" onclick="window.confirmPendingMetadata()"
            class="px-4 py-2 m-4 text-sm font-medium text-gray-900 bg-white border-t border-b border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white">
            Process pending AI metadata
        </button>
    </div>
    <div class="col m-2">
            ...
            <tbody>
                @foreach ($clipart as $item)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            {!! strlen($item->bert_text_embedding_b64) > 0 &&
                            strlen($item->clip_image_embedding_b64) > 0 &&
                            strlen($item->gpt4_description) > 0
                                ? '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#28a745" class="bi bi-check-square-fill" viewBox="0 0 16 16">
                                                                                        <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm10.03 4.97a.75.75 0 0 1 .011 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.75.75 0 0 1 1.08-.022z"/>
                                                                                      </svg>'
                                : '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#dc3545" class="bi bi-x-square-fill" viewBox="0 0 16 16">
