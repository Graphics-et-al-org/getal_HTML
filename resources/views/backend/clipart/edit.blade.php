...
@section('content')
    <div class="container mx-auto p-4 ">
        <h1 class="text-2xl font-bold mb-4">Update Asset</h1>
        <form action="{{ route('admin.clipart.update',$clipart->id ) }}" method="POST" enctype="multipart/form-data" class="group">
            @csrf
                ...
                <div class="border-b border-gray-900/10 pb-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea name="description" id="description" rows="3" value="{{ $clipart->description }}"
