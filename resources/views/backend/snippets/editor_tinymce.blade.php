...
@section('title', __('Snippet editor'))

@section('content')
    <div class="w-100 mb-2">
        {{ isset($snippet->id) ? 'Update' : 'New' }} snippet
    </div>
    <div class="w-100">
        <form id="storeForm"
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="label" id="label" value="{{ $snippet->label ?? 'New snippet' }}"
                    ...
                    <div class="flex-1">
                        <div class="pretty p-svg p-curve p-smooth p-bigger">
                            ...
                            <div class="state p-info">
                                ...
                                <label>Keypoint template?</label>
                            </div>
                        </div>
                        <div class="pretty p-svg p-curve p-smooth p-bigger">
                            <input type="checkbox" name="snippet_template" value="true"
                                {{ isset($snippet) ? ($snippet->snippet_template ? 'checked' : '') : '' }} />
                            <div class="state p-info">
                                <svg class="svg svg-icon" viewBox="0 0 20 20">
                                    <path
                                        d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z"
...
@section('modals')
    ...
    <div id="html-editor-modal" aria-hidden="true" tabindex="-1"
     ...
     <!-- Extra Large Modal -->
    <div id="clipat-modal" aria-hidden="true" tabindex="-1"
        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-full max-h-full">
        <div class="relative w-full max-w-7xl max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <div id="" class="p-4 md:p-5 space-y-4 min-h-full flex overflow-auto">

                </div>
                <!-- Modal footer -->
                <div
                    class="flex items-center p-4 md:p-5 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button type="button" onclick="window.closeClipartModal()"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Close</button>
