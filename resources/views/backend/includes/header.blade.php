...
<nav class="bg-red-200 border-gray-200  h-16 fixed w-full top-0 left-0 z-50 ">
        ...
        <div class="flex items-center lg:order-2">
            <div class="relative">
                @impersonating($guard = null)
                    (Logged in as)
                @endImpersonating{{ Auth::user()->name }}
                @impersonating($guard = null)
                    <br /><a href="{{ route('admin.users.impersonate.leave') }}">(Leave impersonation)</a>
                @endImpersonating
            </div>
            <!-- User profile -->
            <button type="button"
                ...
                <ul class="py-1 text-gray-500 dark:text-gray-400" aria-labelledby="dropdown">
                    <li>
                        <a href="{{ route('admin.dashboard') }}"
                            class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Administration</a>
                    </li>
                    <li>
                        <a href="#"
            ...
            <!-- Dropdown menu -->
            <div class="hidden overflow-hidden z-0 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700"
